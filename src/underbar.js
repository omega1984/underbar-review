(function() {
  ...
  _.filter = function(collection, test) {
    ...
    return result;
    //write a conidtional test
    // if it is true, we push the item into the results
  };
  ...
  _.every = function(collection, iterator = _.identity) {
    ...
    //declare a variable called checkpoint and assign it to true
    let allTrue = true;
  ...
  _.memoize = function(callback) {
    //declare a variable called checkup
    let checkup = {};
    return function() {
      let args = JSON.stringify(arguments);
      if (!checkup[args]) {
        checkup[args] = callback.apply(this, arguments);
      }
      return checkup[args];
    }
  };
